...
namespace CarInsurance.Controllers
{
    public class HomeController : Controller
    {
        ...
        private readonly string connectionString =
            @"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=CarInsuranceContext;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
            ...
            int speedingTickets, string fullCoverage)
        {
            ...
            string queryString = @"INSERT INTO dbo.Customers (firstName, lastName, emailAddress, DOB, carYear, carMake, carModel, DUI, speedingTickets, fullCoverage)
        ...
        {
            string queryString = @"SELECT Id, firstName, lastName, emailAddress, DOB, carYear, carMake, carModel, DUI, speedingTickets, fullCoverage from dbo.Customers";
